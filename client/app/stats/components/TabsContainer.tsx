      ...
      <div className="flex justify-center items-center py-1 w-min backdrop-blur-2xl
       ...
       rounded-lg sticky lg:top-18 md:top-17 sm:top-16 max-sm:top-14.5">
        ...
        <button
          ...
          className="py-1 px-2 mx-4 whitespace-nowrap h-min min-w-25.5 max-sm:min-w-23 max-sm:mx-2 max-sm:text-sm text-center 
           font-medium text-slate-800 dark:text-white border-l-[rgba(255,255,255,0.4)] dark:border-l-[rgba(124,124,124,0.5)] border-l-2"
        >
