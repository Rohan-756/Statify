...
//                             <li
//                                 key={index}
//                                 className={`flex m-2 whitespace-nowrap items-center justify-start 
//                                 gap-4 rounded-md p-2 backdrop-blur-md z-1 
...
const TopArtists = ({ timeRange }: { timeRange: string }) => {
  ...
  return (
    <>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center mt-8 w-full h-[50vh]">
          <div className="spinning-disk" />
          <div className="text-xl text-slate-800 dark:text-white">Loading...</div>
        </div>
      ) : error ? (
        <div className="flex flex-col items-center mt-8 w-full h-screen">
          <div className="text-xl font-semibold text-red-500 TRANS_OFF">
            Failed to load top artists.
          </div>
          <div className="text-slate-800 dark:text-white text-lg font-semibold">
            Please login again.
          </div>
          <a href="/api/login" aria-label="Login again to refresh top artists">
