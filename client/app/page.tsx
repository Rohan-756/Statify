  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-6 gap-y-8 mx-auto w-3/4 max-w-[800px] my-[20px] max-sm:grid-cols-1">
        <div className="text-white font-semibold text-justify flex flex-col justify-center max-sm:order-2">
          <span className="text-2xl font-semibold mb-[2px]">Your music taste is one of a kind.</span>
        ...
        <div className="text-white font-semibold text-justify flex flex-col justify-center max-sm:order-4">
          <section>
            <span className="text-2xl font-semibold mb-[2px]">Connect your Spotify to begin.</span><br />
